...
apiPrivate.interceptors.response.use((response)=>response, async (error)=>{
    ...
    if (// проверим, что ошибка именно из-за невалидного accessToken
    [
        401,
        403
    ].includes(error.response.status) && // проверим, что запрос не повторный
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9a5dd7de._.js.map